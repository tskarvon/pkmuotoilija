...
public class RiviTest {
    ...
    @Test
    public void riviFormatoiTest() {
        Rivi rivi = new Rivi("conels conels conels conels     ");
        tiedot.setLeveys(80);
        rivi.formatoiRivi(tiedot);

        assertEquals("conels conels conels conels", rivi.getSisalto());
    }

    @Test
    public void montaConelsTest() {
        Rivi rivi = new Rivi(" conels conels conels conels conels conels conels conels conels conels conels conels    ");
        tiedot.setLeveys(80);
        rivi.formatoiRivi(tiedot);

        assertEquals("conels conels conels conels conels conels conels conels conels conels conels\n"
                + "conels", rivi.getSisalto());
    }
}
